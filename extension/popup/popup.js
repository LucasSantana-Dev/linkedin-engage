...
const DEFAULT_JOBS_AREA_PRESET = DEFAULT_POPUP_STATE.jobsAreaPreset;
const DEFAULT_CONNECT_USAGE_GOAL = DEFAULT_POPUP_STATE.connectUsageGoal;
const DEFAULT_COMPANY_USAGE_GOAL = DEFAULT_POPUP_STATE.companyUsageGoal;
const DEFAULT_JOBS_USAGE_GOAL = DEFAULT_POPUP_STATE.jobsUsageGoal;
const DEFAULT_EXPECTED_RESULTS = DEFAULT_POPUP_STATE.connectExpectedResults;
